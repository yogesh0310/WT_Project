              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    ...
                    <div class="mt-3">
                      <h4><?php echo $name; ?></h4>
                      <p class="text-secondary mb-1"><?php echo $details[0]['Faculty_id']; ?></p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-8">
              <div class="card mb-3">
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-sm-3">
                      <h6 class="mb-0">Mobile_no</h6>
                    </div>
                    <div class="col-sm-9 text-secondary">
                      <?php echo $details[0]['Mobile']; ?>
                    </div>
                  </div>
                  <hr>
                  <div class="row">
          ...
          <div class="card mb-3">
                <div class="card-body">
                  <div class="row">
                      ...
                      <hr>
                      <div class="row">
                        <input type="button" class="btn btn-success" name="changeNew" value="Change" onclick="changeFacultyPassword()" style="margin-left: 15px;">
                      </div>
                </div>
            </div>
         </div>
