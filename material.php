...
$notes->dept=$_SESSION['dept'];

$depts=$notes->getSubjectNames();
...
<div class="container">
  <div class="row">
    ...
    <div class="col-md-6 input-field" >
      ...
      <input type="button" name="load" class="btn btn-success" value="Load Data" onclick="showData('<?php echo $department; ?>')" style="margin-left: 230px;">
